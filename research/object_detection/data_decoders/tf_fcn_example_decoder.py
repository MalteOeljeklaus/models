...
class TfFCNExampleDecoder(data_decoder.DataDecoder):
  ...
  def __init__(self,
    ...
    self.keys_to_features = {
        ...
        'image/object/group_of':
            tf.VarLenFeature(tf.int64),
        'present_label_indicator':
            tf.FixedLenFeature((), tf.int64, 1),
        'image/seg/height':
            tf.FixedLenFeature((), tf.int64, 1),
        'image/seg/width':
            tf.FixedLenFeature((), tf.int64, 1),
        'image/seg/key/sha256':
            tf.FixedLenFeature((), tf.string, default_value=''),
        'image/seg/numpy_segmentation_map':
            tf.VarLenFeature(tf.float32),
        'image/seg/format':
            tf.FixedLenFeature((), tf.string, default_value='numpy'),
    }
...
#            slim_example_decoder.Tensor('image/seg/numpy_segmentation_map')),
        ...
        fields.FCNExtensionFields.seg_height: (
            slim_example_decoder.Tensor('image/seg/height')),
        fields.FCNExtensionFields.seg_width: (
            slim_example_decoder.Tensor('image/seg/width')),
        fields.FCNExtensionFields.seg_key: (
